	 ...
	 @component('elements.flash') @endcomponent
	  ...
	  <div class="text-center">
		<h3 class="heading">Payment By Stripe</h3>
			...
			<div class='col-md-4'>
				<form accept-charset="UTF-8" action="{{ route('stripe.payment') }}" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_PUBLISH_KEY') }}" id="payment-form" method="post">
					{{ csrf_field() }}
