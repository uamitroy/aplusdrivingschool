...
@section('title') Add Slot @endsection
@section('content')
<div id="page-wrapper">
                    ...
                    <div class="col-lg-12">
                      <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-user"></i> Add Slot <a class="collapse-link pull-right"><i class="fa fa-chevron-up"></i></a></h3>
                            </div>
                            <div class="panel-body">
                            {!! Form::open([ 'route'=> ['admin.slot.store'],'autocomplete'=>'off', 'id'=>'slot','method' => 'POST']) !!}
                            @include('admin.slots._partials.form')                                   
