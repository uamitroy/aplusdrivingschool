                    ...
                    <div class="col-lg-12">
					  <div class="panel panel-default">
                            ...
                            <div class="panel-body">
								...
								<h3 class="card-title">Custom fields <a class="btn btn-success pull-right" id="add_field_button" onclick="add_element({{ $post->id }},'post')"> <i class="fa fa-plus" aria-hidden="true"></i> Add More</a></h3>
								...
								<div class="row">
										  ...
										  <div class="col-md-12 custom-field">
											...
											<div class="col-md-1">
											   <a class="btn btn-info pull-right m-b-10" onclick="update_meta({{ $post->id }},<?=$meta->id?>,<?=$no?>,'post')">Update</a>
											   <a class="btn btn-danger pull-right" onclick="remove_meta(this,<?=$meta->id?>,'post')">Remove</a>
											</div>
										  </div>
										  <?php $no++;?>
										  <?php endforeach;?>
